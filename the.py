...
def sesi_ngentod():
	...
	print(p+"╠════════════════════════════════════════════════════");time.sleep(0.03)
	print(p+"╠══["+h+" ["+k+" Tutor Jebol Sesi "+p+"("+h+" By Sanz-Tzy "+p+") "+h+"");time.sleep(0.03)
	...
	print(p+"║"+m+"* "+p+"("+h+"Duarrr Mwemek, Jebol Deh "+p+"("+k+" Easy Bukan "+p+")"+p+")");time.sleep(0.03)
	print(p+"╠════════════════════════════════════════════════════");time.sleep(0.03)
	print(p+"╠══["+h+" ["+k+" Berikut Cara Jebol Sesi By Sanz-Tzy "+h+"]");time.sleep(0.03)
	print(p+"║"+m+"* "+h+"Muka ke anjing awokawoka:v");time.sleep(0.03)
	print(p+"╠════════════════════════════════════════════════════");time.sleep(0.03)
	print(p+"║"+m+"• "+h+"Kok Masih Ga Jebol Bang?");time.sleep(0.03)
	print(p+"║"+m+"• "+h+"Kurang Ganteng sih awokawoka");time.sleep(0.03)
	print(p+"╠════════════════════════════════════════════════════");time.sleep(0.03)
	print(p+"║");time.sleep(0.03)
#	raw_input (" [ ENTER ]")
